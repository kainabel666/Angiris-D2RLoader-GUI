...
REM v1.3-E1: new plugin_manifest.cpp plugin_install.cpp plugin_drop_ui.cpp repository.cpp repo_browser.cpp readme_reader.cpp logs_modal.cpp mods_modal.cpp (launcher-wide DLL friendly name
